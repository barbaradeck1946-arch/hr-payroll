...
<div class="wrapper-page">
    <div class="page-title">
        <h1><i class="icon-wallet"></i> {{ $mode === 'edit' ? 'Edit Salary Grade' : 'Add Salary Grade' }}</h1>
    </div>
                ...
                <div class="content_wrapper content-padded">
                    <form method="POST" action="{{ $mode === 'edit' ? route('salary-grades.update', $salaryGrade) : route('salary-grades.store') }}">
                        ...
                        <button class="btn btn-custom" type="submit">
                            ...
                            {{ $mode === 'edit' ? 'Update Salary Grade' : 'Create Salary Grade' }}
                        </button>
                        <a href="{{ route('salary-grades.index') }}" class="btn btn-custom-default"><i class="icon-arrow-left"></i> Back</a>
                    </form>
                </div>
            </div>
        </div>
