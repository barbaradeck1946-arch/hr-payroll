...
<div class="wrapper-page">
    ...
    <div class="page-content"><div class="container-fluid"><div class="row g-3">
        <div class="col-md-6"><div class="card no-border"><div class="content_wrapper" style="padding:20px;">
        ...
        <div class="col-md-6"><div class="card no-border"><div class="content_wrapper" style="padding:20px;">
            ...
            <ul class="mb-0">
                @forelse($project->members as $member)
                    <li>{{ trim(($member->first_name ?? '').' '.($member->last_name ?? '')) }} ({{ $member->employee_code }}) - {{ ucfirst($member->pivot->project_role ?? 'member') }}</li>
                @empty
                    <li>No members assigned.</li>
                @endforelse
            </ul>
        </div></div></div>
        <div class="col-md-12"><div class="card no-border"><div class="content_wrapper" style="padding:20px;">
