...
<div class="wrapper-page">
    <div class="page-title d-flex justify-content-between align-items-center">
        <h1><i class="icon-shield"></i> Resignation Final Approvals</h1>
    </div>
                ...
                <div class="content_wrapper content-padded">
                    <form method="GET" class="row g-2 mb-3">
                        ...
                        <div class="col-md-3 d-flex gap-2">
                            ...
                            <a href="{{ route('employee-resignations.final-approvals') }}" class="btn btn-custom-default"><i class="icon-refresh"></i> Reset</a>
                        </div>
                    </form>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered align-middle">
                            ...
                            <tbody>
                                            ...
                                            @if($item->status === 'pending_final')
                                                <div class="d-flex gap-2 flex-column">
                                                    <form method="POST" action="{{ route('employee-resignations.final-process', $item) }}" class="d-flex gap-2 align-items-start">
                                                        ...
                                                        <input type="text" name="final_last_working_day" class="form-control form-control-sm resignation-date-picker" value="{{ $item->requested_last_working_day }}" placeholder="Final LWD" required>
                                                        <button type="submit" class="btn btn-sm btn-success">Final Approve</button>
                                                    </form>
                                                    <form method="POST" action="{{ route('employee-resignations.final-process', $item) }}" class="d-flex gap-2 align-items-start">
                                                        @csrf
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">No requests found for selected filters.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
